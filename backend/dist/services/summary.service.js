 ...
 */
const createSummary = async (originalText, userId, options = {}) => {
 ...
 */
const getSummariesByUser = async (userId, options = {}) => {
 ...
 */
const getSummaryById = async (id, userId) => {
 ...
 */
const deleteSummaryById = async (id, userId) => {
 ...
 */
const generateAISummary = (text, options) => {
