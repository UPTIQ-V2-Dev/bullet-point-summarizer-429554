...
const getSummariesTool: MCPTool = {
    ...
    fn: async (inputs: { userId: number; sortBy?: string; limit?: number; page?: number }) => {
...
const getSummaryTool: MCPTool = {
    ...
    fn: async (inputs: { summaryId: string; userId: number }) => {
...
export const summaryTools: MCPTool[] = [createSummaryTool, getSummariesTool, getSummaryTool, deleteSummaryTool];
